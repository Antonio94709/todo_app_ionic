...
function FetchSingleAPI() {
  ...
  return (
    <>
      <div
        key={data.id}
        className="mx-8 my-8 bg-blue-400 max-w-full flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-blue-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
      >
        <img
